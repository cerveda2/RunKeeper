...
import cz.dcervenka.core.presentation.designsystem.ExclamationMarkIcon
import cz.dcervenka.core.presentation.designsystem.FinishIcon
...
fun TrackerScreenRoot(
    ...
    ObserveAsEvents(viewModel.events) { event ->
        when (event) {
            ...
            TrackerEvent.RunFinished -> onServiceToggle(false)
        }
    }
    TrackerScreen(
